...
-- Dumping data for table chaira_sigepi.pe_evaluacion: ~5 rows (approximately)
...
REPLACE INTO `pe_evaluacion` (`ID_EVALUACION`, `EVA_OBSERVACIONES`, `ID_PE_PROYECTO`, `EVA_PUNTAJE_TOTAL`, `ID_PE_PERSONA`, `EVA_FECHA`, `EVA_ESTADO`) VALUES
	(1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 1, 75, 11, '2020-04-17 16:43:57', '1'),
	(2, 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo', 2, 80, 12, '2020-04-23 16:44:36', '1'),
	...
	(4, 'JLKJLKJLJJJL', 2, 20, 11, '2020-02-28 17:18:44', '1'),
	(5, NULL, 1, NULL, 9, '2020-02-28 17:44:10', '1'),
	(6, NULL, 3, NULL, 12, '2020-02-28 17:45:46', '1');
...
-- Dumping data for table chaira_sigepi.pe_evaluacion_item: ~4 rows (approximately)
...
REPLACE INTO `pe_evaluacion_item` (`ID_EVALUACION_ITEM`, `EVIT_PUNTAJE`, `ID_PE_EVALUACION`, `ID_PE_ITEM`, `EVIT_FECHA_CALIFICACION`) VALUES
	(1, 75, 1, 1, '2020-02-28 16:46:07'),
	(2, 80, 2, 2, '2020-02-28 16:46:47'),
	(3, 90, 3, 3, '2020-02-28 16:47:10'),
	(4, 50, 3, 5, '2020-02-28 16:49:32');
...
REPLACE INTO `pe_objetivos` (`ID_OBJETIVO`, `OBJ_DESCRIPCION`, `OBJ_TIPO`, `ID_PE_PROYECTO`) VALUES
	...
	(3, 'Detectar celulas cancerigenas de mama de manera anticipada,preveniendo enfermedades terminales', 'Genral', 3);
...
-- Dumping data for table chaira_sigepi.pe_proyecto_persona: ~8 rows (approximately)
...
-- Dumping data for table chaira_sigepi.pe_rol: ~9 rows (approximately)
...
-- Dumping data for table chaira_sigepi.pe_tipo_vinculacion: ~3 rows (approximately)
...
INSERT INTO pe_evaluacion()VALUES(num+1,null,id_proyec,null,id_par,NOW(),"1");

SELECT "1" TIPO, "" MENSAJE FROM pe_evaluacion;
